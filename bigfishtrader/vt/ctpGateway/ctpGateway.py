...
from bigfishtrader.gateway import Gateway as VtGateway
...
class CtpTdApi(TdApi):
    ...
    def sendOrder(self, orderReq):
        ...
        vtOrderID = '.'.join([self.gatewayName, str(self.orderRef), self.frontID, self.sessionID])
        return vtOrderID
